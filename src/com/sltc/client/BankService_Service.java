 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "http://BankService.services.ramesh/", wsdlLocation = "http://localhost:8080/ws/bank?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKSERVICE_QNAME = new QName("http://BankService.services.ramesh/", "BankService");
    ...
    public BankService getBankServicePort() {
        return super.getPort(new QName("http://BankService.services.ramesh/", "BankServicePort"), BankService.class);
    }
    ...
    public BankService getBankServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://BankService.services.ramesh/", "BankServicePort"), BankService.class, features);
    }
